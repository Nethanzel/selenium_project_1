...
describe('Input validations', function() {
  ...
  it('Input validations', async function() {
    ...
    await driver.findElement(By.id("name")).sendKeys("Natanael")
    await driver.findElement(By.id("email")).click()
    await driver.findElement(By.id("email")).sendKeys("natanael@hotmail.com")
    await driver.findElement(By.id("subject")).click()
    await driver.findElement(By.id("subject")).sendKeys("Prueba de entradas")
    await driver.findElement(By.id("comment")).click()
    await driver.findElement(By.id("comment")).sendKeys("Este es un texto de prueba")
